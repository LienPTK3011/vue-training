...
class TodoService {
  ...
  updateWorkList(id: any, data:any) {
    return axios.put('https://60c2fe85917002001739dd39.mockapi.io/api/v1/ListWork/' + id, data)
  }
  ...
  existByWorkName(name: string) {
    return axios.get('https://60c2fe85917002001739dd39.mockapi.io/api/v1/ListWork/' + name)
  }
}
